...
In this project, I analyzed marketing funnels below and calculate conversion rates:
...
The queries used to find that data also included in a separate .sql file.
*/
